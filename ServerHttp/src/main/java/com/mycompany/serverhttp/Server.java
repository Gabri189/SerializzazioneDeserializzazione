...
public class Server implements Runnable{ 
	...
	static final String METHOD_NOT_SUPPORTED = "not_supported.html";
        static final String fileJSON = "PuntiVendita.json";
        static final String fileXML = "PuntiVendita.xml";
	...
	public static void main(String[] args) {
                //we open the socket and start the connection
		try {
	...
	public void run() {
		...
		try {
			...
			if (!method.equals("GET")  &&  !method.equals("HEAD")) {
				...
				if (fileRequested.endsWith("/")) {
					fileRequested += DEFAULT_FILE;
                                ...
                                else if(fileRequested.equals("/" + fileXML))
                                {
                                    ...
                                    PuntiVendita p = mapper.readValue(new File(WEB_ROOT + "/" + fileJSON), PuntiVendita.class);
				...
				if (verbose) System.out.println("File " + fileRequested + " of type " + content + " returned");	
			}
			...
			System.err.println("Server error : " + ioe);
                        ...
                        //we close the socket and the connection
			try {
				in.close();
				out.close();
				dataOut.close();
	...
	private byte[] readFileData(File file, int fileLength) throws IOException {
                //...we create a FileInputStream object
		FileInputStream fileIn = null;
                //we take file content
